...
[![Greenkeeper badge](https://badges.greenkeeper.io/WordPress-Coding-Standards/stylelint-config-wordpress.svg)](https://greenkeeper.io/)
...
-   [Style Guide](#style-guide)
    -   [Structure](#structure---handbook--tests)
    -   [Selectors](#selectors---handbook--tests)
    -   [Properties](#properties---handbook--tests)
    -   [Property Ordering](#property-ordering---handbook--todo)
    -   [Vendor Prefixes](#vendor-prefixes---handbook--tests)
    -   [Values](#values---handbook--tests)
    -   [Media Queries](#media-queries---handbook--tests)
    -   [Commenting](#commenting---handbook--tests)
    -   [Best Practices](#best-practices---handbook)
-   [Changelog](#changelog)
-   [License](#license)
